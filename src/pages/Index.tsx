...
const Index = () => {
  ...
  return (
    <Layout>
        ...
        <div className="max-w-[1024px] mx-auto px-4">
          <div className="text-center">
            ...
            {/* <p className="text-lg md:text-xl text-muted-foreground mb-4 max-w-2xl mx-auto">
              The Premier Conference for Indie Game Developers
            </p> */}
            {/* <div>
              <div className="
                flex flex-col items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6
              ...
              ">
                ...
                <div
                  className="
                    w-full h-px bg-primary/20 md:w-px md:h-6 md:bg-primary/20
                    my-1 md:my-0 md:mx-3
                  "
                ></div>
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4" />
                  <span>DEVSISTERS, 도산대로 414 한성청담빌딩 9층</span>
                </div>
              </div>
            </div> */}
            <div className="
      ...
      {/* Sponsors Section */}
      <section className="py-16 md:py-18 overflow-hidden">
        <div className="max-w-[1024px] mx-auto px-4">
        ...
        <div className="max-w-[1024px] mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              UNIDEV is the union of game development clubs, bringing together passionate indie developers
              from across universities and communities. UNICODE is our flagship event where creators
              share knowledge, showcase their work, and build lasting connections.
            </p>
